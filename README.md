...
(如果是剛入門,可以參考我寫的 ： https://hackmd.io/@1p0_VOUHTXGcHlBU9A0OEA/rJ9WuDqY0 有很詳細的內容)
***************************************************************************************************************
RV32I CPU 的實做介紹
...
1. Instruction Mem中含有41條指令,涵蓋R、I、J、U等類型,並且仍可擴充客製化使用
2. 含有Decoder ,所以理論上應該是可以照一般CPU的運作方式去做,只是在沒有pipline和其他優化設計的情況下實際perfromence,area,consumption一定超差
